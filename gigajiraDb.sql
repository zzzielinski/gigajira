...
ALTER TABLE "domains" ADD FOREIGN KEY ("company_id") REFERENCES "companies" ("id") DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE "projects" ADD FOREIGN KEY ("domain_id") REFERENCES "domains" ("id") DEFERRABLE INITIALLY IMMEDIATE;
